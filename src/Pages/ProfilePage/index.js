...
function renderDataSetSelecter (name, selected, setSelectedQuery, count) {
  ...
  if (name === selected) {
    return (
      <div>
        <p className='w-fit underline font-bold cursor-pointer decoration-dashed pb-4'>{name} ({rightText})</p>
      </div>
    )
  } else {
    return (
      <div>
        <p onClick={() => setSelectedQuery(name)} className='w-fit hover:underline font-bold cursor-pointer decoration-dashed pb-4'>{name} ({rightText})</p>
      </div>
    )
  }
}
        ...
        <div className='overflow-auto'>
          <div className='flex flex-col px-8 py-4 h-18 divide-y divide-slate-200 '>
            ...
            <div className='pt-8'>
              ...
              <div className='grid md:grid-cols-5 grid-cols-2 h-18 items-baseline'>
                ...
                <div />
                <div className='grid md:grid-cols-12 grid-cols-4 col-span-2 h-12'>
                  <div className='w-full md:col-span-11 col-span-3'>
                    <input
                      type='text'
                      value={searchText}
                      className='
